			...
			?>
              ...
              <span class="nav-icon">
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M31.3896 19.9439L11.7582 19.9439M20.4122 9.84993L11.1041 20.1196L20.4122 30.3844" stroke="currentColor" stroke-width="4" stroke-miterlimit="10"/>
                </svg>
              </span>
              <span class="nav-content">
                <span class="nav-label"<?php $multi_view->render_attrs( array( 'content' => '{{prev_text}}' ), true ); ?>><?php echo esc_html( $posts_navigation['prev']->title ); ?></span>
                <span class="nav-title"><?php echo get_the_title( $posts_navigation['prev']->id ); ?></span>
              </span>
            </span>
					</a>
				</div>
        ...
        ?>
				>
					<a href="<?php echo esc_url( $posts_navigation['next']->permalink ); ?>" rel="next"<?php echo et_core_esc_previously( $background_class_attr ); ?>>
						...
						<span class="nav-button">
              <span class="nav-content">
                <span class="nav-label"<?php $multi_view->render_attrs( array( 'content' => '{{next_text}}' ), true ); ?>><?php echo esc_html( $posts_navigation['next']->title ); ?></span>
                <span class="nav-title"><?php echo get_the_title( $posts_navigation['next']->id ); ?></span>
              </span>
              <span class="nav-icon">
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8.61035 20.0561H28.2418M19.5878 30.1501L28.8959 19.8804L19.5878 9.6156" stroke="currentColor" stroke-width="4" stroke-miterlimit="10"/>
                </svg>
              </span>
            </span>
					</a>
