...
class Custom_ET_Builder_Module_Number_Counter extends ET_Builder_Module {
	function init() {
        ...
        'before_number' => array(
          'label' => esc_html__('Before Number', 'et_builder'),
        ),
				'number' => array(
        ...
        'after_number' => array(
          'label' => esc_html__('After Number', 'et_builder'),
        ),
	...
	function get_fields() {
      ...
      'before_number' => array(
				'label'           => et_builder_i18n( 'Before Number' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Input a prepend text for the counter.', 'et_builder' ),
				'toggle_slug'     => 'main_content',
				'dynamic_content' => 'text',
				'mobile_options'  => true,
				'hover'           => 'tabs',
      ...
      'after_number' => array(
				'label'           => et_builder_i18n( 'After Number' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Input a append text for the counter.', 'et_builder' ),
				'toggle_slug'     => 'main_content',
				'dynamic_content' => 'text',
				'mobile_options'  => true,
				'hover'           => 'tabs',
    ...
    $before_number = $this->props['before_number'];
    $after_number  = $this->props['after_number'];
		...
		$output = sprintf(
			'<div%1$s class="%2$s" data-number-value="%3$s" data-number-separator="%7$s"%10$s>
				...
				%12$s
				%13$s
				<div class="percent" %4$s%11$s><p><span class="number-before">%14$s</span><span class="percent-value"></span><span class="number-after">%15$s</span><span class="percent-sign">%5$s</span></p></div>
				%6$s
			</div>',
			$this->module_id(),
